...
namespace QuanLyNguoiDungApp.Forms
{
    public partial class SignupForm : Form
    {
        ...
        private void btnDangKy_Click(object sender, EventArgs e)
        {
            ...
            // 1. Kiểm tra nhập đủ thông tin bắt buộc
            ...
            {
                MessageBox.Show("Email đã tồn tại. Đăng nhập ?");
                return;
            }

            // 3. Username chỉ chứa chữ + số
            ...
            {
                MessageBox.Show("Password phải chứa ít nhất 8 ký tự, bao gồm 1 chữ hoa, 1 số, 1 ký tự đặc biệt.");
                return;
            }
            ...
            // 5. Kiểm tra số điện thoại (nếu nhập)
            ...
            // 7. Lưu vào DB và điều hướng đến profile
            try
            {   
                // Lưu vào DB
                string passwordHash = SecurityHelper.HashPassword(password);
                DbHelper.RegisterUser("Nguoichoi", email, username, phone, passwordHash, dob);
